        ...
        <div className="bg-zinc-900 rounded-lg p-8 md:p-12 border border-zinc-800">
          ...
          <div className="bg-black rounded-lg p-6 mb-8 border border-zinc-700">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-2xl font-bold text-[#0e9a20]">R$ 50,00</span>
            </div>
          ...
          <div className="space-y-4 mb-8">
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-[#0e9a20]/20 rounded-full flex items-center justify-center">
                  <Smartphone className="w-6 h-6 text-[#0e9a20]" />
                </div>
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-[#0e9a20]/20 rounded-full flex items-center justify-center">
                  <CreditCard className="w-6 h-6 text-[#0e9a20]" />
                </div>
                <div className="flex-1">
          ...
          <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
            <div className="flex items-center gap-3">
              <Check className="w-5 h-5 text-[#0e9a20]" />
              <div>
